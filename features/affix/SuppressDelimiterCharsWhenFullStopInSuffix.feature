Feature: affix
  ...
  I want the test affix_SuppressDelimiterCharsWhenFullStopInSuffix to pass

  @citation @affix @citations
  Scenario: Suppress Delimiter Chars When Full Stop In Suffix
    ...
    """
    [{"author":[{"family":"Smith","given":"John"}],"id":"ITEM-1","issued":{"date-parts":[["1990"]]},"title":"First Book","type":"book"},{"author":[{"family":"Brown","given":"John"}],"id":"ITEM-2","issued":{"date-parts":[["2010"]]},"title":"Second Book","type":"book"},{"author":[{"family":"Green","given":"John"}],"id":"ITEM-3","issued":{"date-parts":[["2010"]]},"title":"Third Book","type":"book"}]
    """
