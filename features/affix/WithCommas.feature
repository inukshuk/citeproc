Feature: affix
  ...
  I want the test affix_WithCommas to pass
  ...
  Scenario: With Commas
    ...
    <style xmlns="http://purl.org/net/xbiblio/csl" class="note" version="1.0" demote-non-dropping-particle="sort-only">
      <info>
        <title>Chicago Manual of Style (Full Note w. Bibliography) [delimiter fixes]</title>
        <id>http://www.zotero.org/styles/chicago-fullnote-bibliography-delimiter-fixes</id>
        <link href="http://www.zotero.org/styles/chicago-fullnote-bibliography-delimiter-fixes" rel="self"/>
        ...
        <summary>Chicago format with full notes and bibliography (with delimiter fixes)</summary>
    ...
    """
    [{"author":[{"family":"Smith","given":"John"}],"id":"ITEM-1","issued":{"date-parts":[["2000","2","15"]]},"title":"Book C","type":"book"},{"author":[{"family":"Jones","given":"David"}],"id":"ITEM-2","issued":{"date-parts":[["2000","2","15"]]},"title":"Book D","type":"book"}]
    """
    When I cite the following items:
    """
    [[{"id":"ITEM-1"},{"id":"ITEM-2","prefix":", and "}],[{"id":"ITEM-1","suffix":" is one source,"},{"id":"ITEM-2","suffix":" is another."}],[{"id":"ITEM-1","locator":23,"suffix":" is one source,"},{"id":"ITEM-2","suffix":" is another."}]]
    """
    Then the results should be:
      | John Smith, <i>Book C</i>, 2000, and David Jones, <i>Book D</i>, 2000.  |
      | John Smith, <i>Book C</i>, 2000 is one source, David Jones, <i>Book D</i>, 2000 is another. |
      | John Smith, <i>Book C</i>, 2000, 23 is one source, David Jones, <i>Book D</i>, 2000 is another. |
