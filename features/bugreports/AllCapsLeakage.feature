Feature: bugreports
  ...
  I want the test bugreports_AllCapsLeakage to pass

  @bibliography @bugreports
  Scenario: All Caps Leakage
    ...
    """
    [{"author":[{"family":"Doe","given":"John"}],"container-title":"His Anonymous Life","editor":[{"family":"Roe","given":"Jane"}],"id":"ITEM-1","issued":{"date-parts":[["1965","6","1"]]},"title":"His Anonymous Life","type":"chapter"}]
    """
