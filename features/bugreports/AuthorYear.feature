Feature: bugreports
  ...
  I want the test bugreports_AuthorYear to pass
  ...
  Scenario: Author Year
    ...
    """
    [{"author":[{"family":"Family01","given":"Given01"}],"id":"ITEM-1","issued":{"date-parts":[[2003,1]]},"title":"This is some title","type":"book","volume":"2003"}]
    """
