Feature: bugreports
  ...
  I want the test bugreports_AutomaticallyDeleteItemsFails to pass

  @bibliography @bugreports @citations
  Scenario: Automatically Delete Items Fails
    ...
    """
    [{"author":[{"family":"Doe","given":"John"}],"id":"ITEM-1","issued":{"date-parts":[["2000"]]},"title":"Book A","type":"book"},{"author":[{"family":"Doe","given":"John"}],"id":"ITEM-2","issued":{"date-parts":[["2000"]]},"title":"Book B","type":"book"},{"author":[{"family":"Snoakes","given":"Richard"}],"id":"ITEM-3","issued":{"date-parts":[["2000"]]},"title":"Book C","type":"book"}]
    """
