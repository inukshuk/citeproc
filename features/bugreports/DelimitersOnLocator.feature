Feature: bugreports
  ...
  I want the test bugreports_DelimitersOnLocator to pass

  @citation @bugreports @citations
  Scenario: Delimiters On Locator
    ...
    """
    [{"author":[{"family":"Doe","given":"John"}],"id":"ITEM-1","title":"His Anonymous Life","type":"book"},{"author":[{"family":"Doe","given":"John"}],"id":"ITEM-2","title":"His Anonymous Life","type":"book"},{"author":[{"family":"Doe","given":"John"}],"id":"ITEM-3","title":"His Anonymous Life","type":"book"}]
    """
