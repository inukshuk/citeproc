Feature: bugreports
  ...
  I want the test bugreports_DemoPageFullCiteCruftOnSubsequent to pass

  @citation @bugreports @citation-items
  Scenario: Demo Page Full Cite Cruft On Subsequent
    ...
    <style
      ...
      <macro name="contributors">
        <names variable="author">
          <name and="text" delimiter=", " delimiter-precedes-last="always" name-as-sort-order="first" sort-separator=", " form="long"/>
          <substitute>
            <text macro="editor" />
      ...
      <macro name="recipient-short">
        <text value="[start short name X WTF?]"/>
        <names variable="recipient">
          <label form="verb" prefix=" " suffix=" " text-case="lowercase" />
          <name and="text" delimiter=", " />
        </names>
        <text value="[end short name X WTF?]"/>
      </macro>
      ...
      <bibliography
        ...
        <layout suffix=".">	
      <choose>	
      <if type="legal_case">		<text macro="legal-case-first"/>	
      </if>
          <else>
          <group delimiter=". ">
