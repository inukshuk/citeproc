Feature: bugreports
  ...
  I want the test bugreports_DuplicateSpaces2 to pass

  @bibliography @bugreports
  Scenario: Duplicate Spaces2
    ...
    """
    [{"author":[{"family":"Smith","given":"John"}],"container-title":"Container Title","id":"ITEM-1","title":"Some Title","type":"article-journal"}]
    """
