Feature: bugreports
  ...
  I want the test bugreports_FourAndFour to pass

  @citation @bugreports @citations
  Scenario: Four And Four
    ...
    """
    [{"ISBN":"9780804113472","author":[{"family":"Tyler","given":"Anne"},{"family":"Smith","given":"George"},{"family":"Brown","given":"John"},{"family":"Garfield","given":"Cat"}],"id":1,"issued":{"date-parts":[[1997]]},"publisher":"Ivy Books","publisher-place":"New York","title":"Ladder of his' Years","type":"book","volume":"2003"},{"ISBN":"9780804113472","author":[{"family":"Tyler","given":"Anne"},{"family":"Smith","given":"George"},{"family":"Brown","given":"John"},{"family":"Felix","given":"Cat"}],"id":2,"issued":{"date-parts":[[1997]]},"publisher":"Ivy Books","publisher-place":"New York","title":"Ladder of his' Years","type":"book","volume":"2003"}]
    """
    And I have a citations input
    When I cite all items
    Then the result should be:
    """
    >>[0] Anne Tyler, George Smith, John Brown, and Cat Garfield, <i>Ladder of his’ Years</i>, vol. 2003 (New York: Ivy Books, 1997).
    >>[1] Anne Tyler, George Smith, John Brown, and Cat Felix, <i>Ladder of his’ Years</i>, vol. 2003 (New York: Ivy Books, 1997).
    """
