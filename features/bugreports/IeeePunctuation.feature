Feature: bugreports
  ...
  I want the test bugreports_IeeePunctuation to pass

  @bibliography @bugreports
  Scenario: Ieee Punctuation
    ...
    """
    [{"author":[{"family":"Zimbardo","given":"Philip G"}],"container-title":"American Psychologist","id":"ITEM-1","issue":"5","issued":{"date-parts":[[2004,1]]},"page":"339-351","title":"Does Psychology make a significant difference in our lives?","type":"article-journal","volume":"59"}]
    """
