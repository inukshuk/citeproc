Feature: bugreports
  ...
  I want the test bugreports_LabelsOutOfPlace to pass

  @bibliography @bugreports
  Scenario: Labels Out Of Place
    ...
    """
    [{"author":[{"family":"Jones","given":"Colin"}],"editor":[{"family":"Lucas","given":"Colin"}],"id":"ITEM-1","issued":{"date-parts":[[1991]]},"publisher":"Clarendon Press","publisher-place":"Oxford","title":"Bourgeois Revolution Revivified: 1789 and Social Change","type":"book"}]
    """
