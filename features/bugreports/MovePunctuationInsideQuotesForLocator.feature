Feature: bugreports
  ...
  I want the test bugreports_MovePunctuationInsideQuotesForLocator to pass

  @citation @bugreports @citations
  Scenario: Move Punctuation Inside Quotes For Locator
    ...
    """
    [{"author":[{"family":"Davis","given":"Jennifer J."}],"genre":"Ph.D. diss.","id":"ITEM-1","issued":{"date-parts":[[2004]]},"publisher":"Pennsylvania State University, History","title":"Men of Taste: Gender and Authority in the French Culinary Trades, 1730-1830","type":"thesis"}]
    """
    And I have a citations input
    When I cite all items
    Then the result should be:
    """
    >>[0] Jennifer J. Davis, “Men of Taste: Gender and Authority in the French Culinary Trades, 1730-1830” (Ph.D. diss., Pennsylvania State University, History, 2004), s.v. “gargoyle.”
    """
