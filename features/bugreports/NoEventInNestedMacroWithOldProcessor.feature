Feature: bugreports
  ...
  I want the test bugreports_NoEventInNestedMacroWithOldProcessor to pass

  @bibliography @bugreports
  Scenario: No Event In Nested Macro With Old Processor
    ...
    """
    [{"event":"Big Event","id":"ITEM-1","title":"My Anonymous Paper","type":"paper-conference"},{"event":"Other Big Event","id":"ITEM-2","title":"My Anonymous Speech","type":"speech"}]
    """
