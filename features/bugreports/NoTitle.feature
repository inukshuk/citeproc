Feature: bugreports
  ...
  I want the test bugreports_NoTitle to pass
  ...
  Scenario: No Title
    ...
    """
    [{"author":[{"family":"Family01","given":"Given01"}],"id":"ITEM-1","title":"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX","type":"article-journal"},{"id":"ITEM-2","title":"ecs","type":"article-journal"}]
    """
