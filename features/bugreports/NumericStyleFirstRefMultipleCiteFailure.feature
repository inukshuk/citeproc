Feature: bugreports
  ...
  I want the test bugreports_NumericStyleFirstRefMultipleCiteFailure to pass

  @citation @bugreports @citations
  Scenario: Numeric Style First Ref Multiple Cite Failure
    ...
    """
    [{"author":[{"family":"Doe","given":"John"}],"id":5,"issued":{"date-parts":[["2000"]]},"title":"Book A","type":"book"},{"author":[{"family":"Doe","given":"John"}],"id":8,"issued":{"date-parts":[["2000"]]},"title":"Book B","type":"book"}]
    """
