Feature: bugreports
  ...
  I want the test bugreports_SortSecondaryKey to pass

  @citation @bugreports @citations
  Scenario: Sort Secondary Key
    ...
    """
    [{"author":[{"family":"Roe","given":"Jane"}],"id":"ITEM-1","issued":{"date-parts":[[1996]]},"type":"book"},{"author":[{"family":"Roe","given":"Jane"}],"id":"ITEM-2","issued":{"date-parts":[[1995]]},"type":"book"}]
    """
