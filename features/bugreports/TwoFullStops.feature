Feature: bugreports
  ...
  I want the test bugreports_TwoFullStops to pass

  @bibliography @bugreports
  Scenario: Two Full Stops
    ...
    """
    [{"author":[{"family":"author01","given":"author01"}],"edition":"Mega Edition","id":"ITEM-1","issued":{"date-parts":[[1998,1]]},"title":"Test Title","type":"book"}]
    """
    And the following abbreviations:
    """
    {"default":{"number":{"Mega Edition":"Mega ed."}}}
    """
    When I render the entire bibliography
    Then the bibliography should be:
    """
    <div class="csl-bib-body">
      <div class="csl-entry">author01, author01. 1998. <i>Test Title</i>. Mega ed. January.</div>
    </div>
    """
