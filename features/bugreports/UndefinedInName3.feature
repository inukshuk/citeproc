Feature: bugreports
  ...
  I want the test bugreports_UndefinedInName3 to pass

  @citation @bugreports @citation-items
  Scenario: Undefined In Name3
    ...
    """
    [{"author":[{"family":"Kim","given":"B-X"},{"family":"Kim","given":"A-Y"}],"id":"ITEM-1","type":"book"}]
    """
    When I cite the following items:
    """
    [[{"id":"ITEM-1","position":0}],[{"id":"ITEM-1","label":"page","locator":"23","position":2}]]
    """
