Feature: bugreports
  ...
  I want the test bugreports_disambiguate to pass

  @citation @bugreports
  Scenario: disambiguate
    ...
    """
    [{"author":[{"family":"FamilyA","given":"GivenA D."},{"family":"FamilyB","given":"GivenB P."}],"container-title":"Container Title01","id":"ITEM-1","issued":{"date-parts":[[2003,1]]},"title":"Title01","type":"article-journal"},{"author":[{"family":"FamilyA","given":"GivenA D."},{"family":"FamilyC","given":"GivenC1 GivenC2"},{"family":"FamilyB","given":"GivenB P"}],"container-title":"Container Title02","id":"ITEM-2","issued":{"date-parts":[[2007,1]]},"title":"Title02","type":"article-journal"}]
    """
