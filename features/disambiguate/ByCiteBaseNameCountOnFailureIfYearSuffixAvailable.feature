Feature: disambiguate
  ...
  I want the test disambiguate_ByCiteBaseNameCountOnFailureIfYearSuffixAvailable to pass

  @citation @disambiguate
  Scenario: By Cite Base Name Count On Failure If Year Suffix Available
