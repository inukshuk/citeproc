Feature: disambiguate
  ...
  I want the test disambiguate_YearSuffixMixedDates to pass

  @citation @disambiguate
  Scenario: Year Suffix Mixed Dates
    ...
    """
    [{"author":[{"family":"Ylinen","given":"A"}],"id":22,"issued":{"date-parts":[[1995]]},"type":"article-journal"},{"author":[{"family":"Ylinen","given":"A"}],"id":21,"issued":{"date-parts":[["1995"]]},"type":"article-journal"},{"author":[{"family":"Ylinen","given":"A"}],"id":23,"issued":{"date-parts":[["1995"]]},"type":"article-journal"}]
    """
