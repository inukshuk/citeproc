Feature: display
  ...
  I want the test display_SecondFieldAlignMigratePunctuation to pass

  @bibliography @display @non-standard
  Scenario: Second Field Align Migrate Punctuation
