Feature: group
  ...
  I want the test group_ComplexNesting to pass
  ...
  Scenario: Complex Nesting
    ...
    """
    [{"URL":"http://example.com/","accessed":{"date-parts":[["1965","6","1"]]},"author":[{"family":"Doe Inc.","isInstitution":true}],"id":"ITEM-1","type":"webpage"}]
    """
