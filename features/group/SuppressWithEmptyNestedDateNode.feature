Feature: group
  ...
  I want the test group_SuppressWithEmptyNestedDateNode to pass

  @bibliography @group
  Scenario: Suppress With Empty Nested Date Node
    ...
    """
    [{"author":[{"family":"Author1","given":"One"},{"family":"Author7","given":"Two"},{"family":"Author3","given":"Three"}],"container-title":"Test Journal","id":"ITEM-1","issued":{"date-parts":[["2008","10","16"]]},"title":"Test Article","type":"article-journal","volume":"12"}]
    """
