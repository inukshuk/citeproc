Feature: magic
  ...
  I want the test magic_SuppressExtraTerminalPunctuationAfterTerm to pass

  @citation @magic @citations
  Scenario: Suppress Extra Terminal Punctuation After Term
    ...
    """
    [{"author":[{"family":"Smith","given":"John"}],"id":"ITEM-1","issued":{"date-parts":[["1990"]]},"title":"Book","type":"book"}]
    """
