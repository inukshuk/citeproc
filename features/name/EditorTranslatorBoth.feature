Feature: name
  ...
  I want the test name_EditorTranslatorBoth to pass

  @bibliography @name
  Scenario: Editor Translator Both
    ...
    """
    [{"author":[{"family":"Noakes","given":"Richard"}],"editor":[{"family":"Doe","given":"John"}],"id":"ITEM-1","title":"Hello","translator":[{"family":"Roe","given":"Jane"}],"type":"book"}]
    """
