Feature: name
  ...
  I want the test name_EditorTranslatorWithTranslatorOnlyBib to pass

  @bibliography @name
  Scenario: Editor Translator With Translator Only Bib
    ...
    """
    [{"author":[{"family":"Noakes","given":"Richard"}],"id":"ITEM-1","title":"Hello","translator":[{"family":"Roe","given":"Jane"}],"type":"book"}]
    """
