Feature: name
  ...
  I want the test name_MixedFormatsPrimaryDecorations to pass

  @citation @name
  Scenario: Mixed Formats Primary Decorations
    ...
    """
    Пётр Ильич ЧАЙКОВСКИЙ, Rip VAN WINKLE, 我妻栄, Carl THUCYDIDES III, TOKUGAWA Ieyasu, Prince
    """
