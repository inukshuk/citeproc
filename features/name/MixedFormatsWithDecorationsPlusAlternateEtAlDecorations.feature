Feature: name
  ...
  I want the test name_MixedFormatsWithDecorationsPlusAlternateEtAlDecorations to pass

  @citation @name
  Scenario: Mixed Formats With Decorations Plus Alternate Et Al Decorations
      ...
      <citation 
        ...
        <layout delimiter="; ">
          <names variable="author">
            ...
            <et-al font-style="italic" prefix=" " term="and others" />
          </names>
        </layout>
      </citation>
    </style>
    ...
    """
    Пётр Ильич ЧАЙКОВСКИЙ, Rip VAN WINKLE, 我妻栄, Carl THUCYDIDES III, TOKUGAWA Ieyasu, <i>and others</i>
    """
