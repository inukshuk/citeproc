Feature: name
  ...
  I want the test name_MixedFormatsWithDecorationsPlusEtAlDecorations to pass

  @citation @name
  Scenario: Mixed Formats With Decorations Plus Et Al Decorations
    ...
    """
    Пётр Ильич ЧАЙКОВСКИЙ, Rip VAN WINKLE, 我妻栄, Carl THUCYDIDES III, TOKUGAWA Ieyasu, <i>et al.</i>
    """
