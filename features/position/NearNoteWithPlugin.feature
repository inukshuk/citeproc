Feature: position
  ...
  I want the test position_NearNoteWithPlugin to pass

  @citation @position @citations
  Scenario: Near Note With Plugin
    ...
    """
    [{"container-title":"N.Y.2d","id":97,"issued":{"date-parts":[[1989]]},"multi":{"_keys":{}},"page":"683","title":"People v. Taylor","type":"legal_case","volume":"73"}]
    """
