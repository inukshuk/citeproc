Feature: punctuation
  ...
  I want the test punctuation_SuppressPrefixPeriodForDelimiterSemicolon to pass

  @citation @punctuation @citations
  Scenario: Suppress Prefix Period For Delimiter Semicolon
    ...
    """
    [{"author":[{"family":"Doe","given":"John"}],"id":"ITEM-1","issued":{"date-parts":[["1965","6","1"]]},"title":"His Anonymous Life","type":"chapter"},{"author":[{"family":"Roe","given":"Jane"}],"id":"ITEM-2","issued":{"date-parts":[["1965","6","1"]]},"title":"Her Anonymous Life","type":"chapter"}]
    """
