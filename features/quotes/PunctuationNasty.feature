Feature: quotes
  ...
  I want the test quotes_PunctuationNasty to pass

  @bibliography @quotes
  Scenario: Punctuation Nasty
    Given the following style:
    """
    <?xml version="1.0" encoding="utf-8"?>
    <style xmlns="http://purl.org/net/xbiblio/csl" class="note" version="1.0" demote-non-dropping-particle="sort-only">
      <info>
        <title>Chicago Manual of Style (no ibid - Full Note w. Bibliography)</title>
    ...
    """
    [{"archive":"Bancroft Library, University of California at Berkeley","archive_location":"MSS C-E 191","author":[{"family":"Savage","given":"Thomas"}],"id":"ITEM-1","issued":{"date-parts":[["1879"]]},"title":"Report of Labors in Archives and Procuring Material for History of California: And Related Material","type":"manuscript"}]
    """
