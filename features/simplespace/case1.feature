Feature: simplespace
  ...
  I want the test simplespace_case1 to pass

  @bibliography @simplespace
  Scenario: case1
    ...
    """
    [{"author":[{"family":"Doe","given":"Jhon"}],"container-title":"Some title","edition":"Vintage First edition","id":"ITEM-1","issued":{"date-parts":[[1992]]},"page":"250-300","publisher":"Vintage","type":"chapter"}]
    """
